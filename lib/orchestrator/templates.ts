...
export function renderStarterApp(spec: AppSpec): GeneratedApp {
  return {
    name: spec.appName,
    ...
    files: [
      ...
      },
      {
        ...
        content: renderClaudeWorkflow(),
      },
      {
        path: "CLAUDE.md",
        content: renderClaudeInstructions(spec),
      },
...
function renderClaudeInstructions(spec: AppSpec): string {
  return `# ${spec.appName}
